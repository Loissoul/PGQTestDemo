...
-(void)commonInit
{
    self.image = [UIImage imageNamed:@"avator.png"];
    [self addTopView];
    [self addBottomView];
...
-(void) addTopView{
    ...
    self.topView.image = [self cutImageWithID:@"top"];      self.topView.userInteractionEnabled = YES;
    ...
    self.topShadowLayer.opacity = NO;
    [self.topView.layer addSublayer:self.topShadowLayer];
    
    [self addSubview:_topView];
}

#pragma mark  part of Bottom
-(void) addBottomView{

...
@property (nonatomic, strong) PGQInteractiveTransition *interactiveTransitionPop;
...
- (void)viewDidLoad {
    ...
    //初始化手势过渡的代理
    _interactiveTransitionPop = [PGQInteractiveTransition transitionWithType:PGQNavTransitionTypePop Direction:PGQNavTransitionGestureDirectionRight];
    //给当前控制器的视图添加手势
...
- (id<UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController interactionControllerForAnimationController:(id<UIViewControllerAnimatedTransitioning>)animationController{
    if (_operation == UINavigationControllerOperationPush) {
        PGQInteractiveTransition *interactiveTransitionPush = [_delegate interactiveTransitionForPush];

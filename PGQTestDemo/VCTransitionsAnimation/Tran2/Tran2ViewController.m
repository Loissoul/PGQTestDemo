...
- (void)viewDidLoad {
    ...
    _interactivePush = [PGQInteractiveTransition transitionWithType:PGQNavTransitionTypePresent Direction:PGQNavTransitionGestureDirectionUp];

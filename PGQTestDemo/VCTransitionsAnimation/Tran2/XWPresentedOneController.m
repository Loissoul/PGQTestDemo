...
@property (nonatomic, strong) PGQInteractiveTransition *interactiveDismiss;
@property (nonatomic, strong) PGQInteractiveTransition *interactivePush;
@end
...
- (void)viewDidLoad {
    ...
    self.interactiveDismiss = [PGQInteractiveTransition transitionWithType:PGQNavTransitionTypeDismiss Direction:PGQNavTransitionGestureDirectionDown];
...
- (id<UIViewControllerInteractiveTransitioning>)interactionControllerForPresentation:(id<UIViewControllerAnimatedTransitioning>)animator{
    PGQInteractiveTransition *interactivePresent = [_delegate interactiveTransitionForPresent];
